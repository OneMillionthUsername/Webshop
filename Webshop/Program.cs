...
namespace Webshop
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // HttpContextAccessor f�r Session/Cookie-Zugriff
            ...
            // Datenbank-Migrationen automatisch beim Start ausf�hren
            using (var scope = app.Services.CreateScope())
            {
                ...
                try
                {
                    ...
                    // ?? Erst pr�fen ob Verbindung m�glich ist
                    ...
                    {
                        // Falls Verbindung fehlschl�gt, DB erstellen
                ...
                catch (Exception ex)
                {
                    ...
                    throw; // Exception propagieren damit Container crasht wenn DB-Init fehlschl�gt
                }
            }
